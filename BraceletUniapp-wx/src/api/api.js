...
export function aiRecommend(prompt, useTarot = false) {
  return post(API_PATHS.AI_RECOMMEND, { prompt, useTarot }, true, 120000)
}

/**
 * 获取AI算命搭配推荐（八卦命理）
 * @param {String} prompt 用户输入拼接后的需求
 * @returns {Promise}
 */
export function aiFortuneRecommend(prompt) {
  return post(API_PATHS.AI_FORTUNE_RECOMMEND, { prompt }, true, 120000)
}
